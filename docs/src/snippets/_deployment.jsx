...
//                      For matchDims rows, blocked options leave the tab order
//                      and expose disableReason only through the title tooltip.
//                      The tap-to-reveal note is available only in the
//                      commandBuilder renderer.
